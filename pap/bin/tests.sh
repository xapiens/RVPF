...
classes=$RVPF_SHARE_JAVA/rvpf-pap-base.jar
classes=$classes:$RVPF_SHARE_JAVA/rvpf-pap-cip.jar
classes=$classes:$RVPF_SHARE_JAVA/rvpf-pap-dnp3.jar
classes=$classes:$RVPF_SHARE_JAVA/rvpf-pap-modbus.jar
tests_classes=$RVPF_SHARE_JAVA/rvpf-pap-tests.jar
if [ -n "$RVPF_SUB" ]; then
...
CLASSPATH=$CLASSPATH:$RVPF_CORE_SHARE_JAVA/rvpf-forwarder.jar:$RVPF_CORE_SHARE_JAVA/rvpf-processor.jar
CLASSPATH=$CLASSPATH:$RVPF_CORE_SHARE_JAVA/rvpf-core-tests.jar
CLASSPATH=$CLASSPATH:$RVPF_SHARE_JAVA/jssc.jar
CLASSPATH=$CLASSPATH:$RVPF_SHARE_JAVA/etherip.jar
LIBPATH=$RVPF_LIB:$RVPF_CORE_LIB/lib
