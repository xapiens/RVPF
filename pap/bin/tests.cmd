...
SET classes=%RVPF_LIB%\rvpf-pap-base.jar
SET classes=%classes%;%RVPF_LIB%\rvpf-pap-cip.jar
SET classes=%classes%;%RVPF_LIB%\rvpf-pap-dnp3.jar
SET classes=%classes%;%RVPF_LIB%\rvpf-pap-modbus.jar
SET tests_classes=%RVPF_LIB%\rvpf-pap-tests.jar
IF EXIST %RVPF_SUB%\build\main\classes SET classes=%RVPF_SUB%\shared;%RVPF_SUB%\build\main\classes
...
SET CLASSPATH=%CLASSPATH%;%RVPF_CORE_LIB%\rvpf-http.jar;%RVPF_CORE_LIB%\rvpf-store.jar
SET CLASSPATH=%CLASSPATH%;%RVPF_CORE_LIB%\rvpf-forwarder.jar;%RVPF_CORE_LIB%\rvpf-processor.jar
SET CLASSPATH=%CLASSPATH%;%RVPF_CORE_LIB%\rvpf-core-tests.jar
SET CLASSPATH=%CLASSPATH%;%RVPF_LIB%\jssc.jar
SET CLASSPATH=%CLASSPATH%;%RVPF_LIB%\etherip.jar
