...
@SuppressWarnings(
{
    "synthetic-access", "hiding", "boxing"
})
final public class CIPData
{
     ...
     */
    public CIPData(final Type type, final byte[] data)
        throws Exception
    {
        this.type = type;
     ...
     */
    public CIPData(final Type type, final int elements)
        throws Exception
    {
        switch (type) {
            case BOOL:
        ...
        throws Exception
    {
        ...
        if (this.type == Type.STRUCT) {
            ...
            if (struct_detail != Type.STRUCT_STRING.code) {
                throw new Exception(
                    "Can only encode STRUCT_STRING, got 0x"
                    + Integer.toHexString(
                        struct_detail));
            }
     ...
     *             if index is invalid
     */
    final synchronized public Number getNumber(
            final int index)
     ...
     */
    final synchronized public String getString()
        throws Exception
    {
        if (this.type != Type.STRUCT) {
            throw new Exception(
    ...
    {
        return this.type.getCode() <= Type.DWORD.getCode();
    }
     ...
     *             if index is invalid
     */
    final synchronized public void set(
            final int index,
            final Number value)
        throws Exception, IndexOutOfBoundsException
    {
        switch (this.type) {
            ...
            case SINT:
                this.data
                    .put(this.type.element_size * index, value.byteValue());

                break;
            case INT:
                this.data
                    .putShort(
                        this.type.element_size * index,
                        value.shortValue());

                break;
            case DINT:
                this.data
                    .putInt(this.type.element_size * index, value.intValue());
     ...
     *             if data does not contain a string
     */
    final synchronized public void setString(final String text)
        throws Exception
    {
        if (this.type != Type.STRUCT) {
            throw new Exception(
        ...
        switch (this.type) {
            ...
            case STRUCT: {
                ...
                try {
                    ...
                    result
                        .append(
                            "Structure element with type code 0x"
                            + Integer.toHexString(
                                code));
    ...
    final private short determineElementCount()
        throws Exception
    {
        switch (this.type) {
            case BOOL:
    ...
    public static enum Type
    {
        ...
        public static Type forCode(final short code)
            throws Exception
        {
