    ...
    implements AutoCloseable
{
     ...
     * @return The status description of the latest multiple commands.
     */
    public String decodeStatus(final int index)
    {
        return MessageRouterProtocol.decodeStatus(_statuses[index]);
    }

    public void executeRequest(Protocol request)
        throws Exception
    {
    ...
    public EthernetLink getEthernetLink(final int instance)
        throws Exception
    {
        ...
        final Encapsulation encap = new Encapsulation(
            ...
            this.connection.getSession(),
            new SendRRDataProtocol(
                new MessageRouterProtocol(
                    Get_Attribute_All,
                    CNPath.EthernetLink().instance(instance),
        ...
        final Encapsulation encap = new Encapsulation(
            ...
            new SendRRDataProtocol(
                new MessageRouterProtocol(
                    ...
                    classPath.instance(instance).attr(attr),
        ...
        throws Exception
    {
        ...
        final Encapsulation encap = new Encapsulation(
            ...
            this.connection.getSession(),
            new SendRRDataProtocol(
                new UnconnectedSendProtocol(
                    slot,
                    new MessageRouterProtocol(
                            Get_Attribute_Single,
                                    classPath.instance(instance).attr(attr),
                                    attr_proto =
                                        new GetHexStringDataProtocol()))));
    ...
    public String getHexStringAttributeAll(
            final CNClassPath classPath,
            final int instance)
        throws Exception
    {
        ...
        throws Exception
    {
        ...
        final Encapsulation encap = new Encapsulation(
            ...
            new SendRRDataProtocol(
                new MessageRouterProtocol(
                    Get_Attribute_Single,
                    CNPath.TcpIpInterface().instance(instance).attr(5),
        ...
        throws Exception
    {
        ...
        final Encapsulation encap = new Encapsulation(
            ...
            new SendRRDataProtocol(
                new MessageRouterProtocol(
                    Get_Attribute_Single,
                    CNPath.TcpIpInterface().instance(instance).attr(4),
    ...
    public Identity getSlotIdentity(final int slot)
        throws Exception
    {
        final GetIdentityProtocol attr_proto;
        final Encapsulation encap = new Encapsulation(
    ...
    /**
     * @param index The index of the command.
     * @return The status of the latest multiple commands.
     */
                ...
                new UnconnectedSendProtocol(
                    ...
                    new MessageRouterProtocol(
                            Get_Attribute_Single,
                                    classPath.instance(instance).attr(attr),
                                    attr_proto =
                                        new GetStringAttributeProtocol()))));
    ...
    public TcpIpInterface getTcpIpInterface(final int instance)
        throws Exception
    {
        try {
            ...
            final Encapsulation encap = new Encapsulation(
                ...
                new SendRRDataProtocol(
                    new MessageRouterProtocol(
                        Get_Attribute_All,
                        CNPath.TcpIpInterface().instance(instance),
    ...
    public TcpIpInterface getTcpIpInterfaceWithGetAttributeSingle(
            final int instance)
        throws Exception
    {
        ...
        tcpIpInterface
            .setInterfaceConfiguration(
                this.getInterfaceConfiguration(instance));
        tcpIpInterface
            .setHostName(
                this.getStringAttribute(CNPath.TcpIpInterface(), instance, 6));
        tcpIpInterface
            .setStatus(
                this.getIntAttribute(CNPath.TcpIpInterface(), instance, 1));
        tcpIpInterface
            .setConfigurationCapability(
                this.getIntAttribute(CNPath.TcpIpInterface(), instance, 2));
        tcpIpInterface
            .setConfigurationControl(
                this.getIntAttribute(CNPath.TcpIpInterface(), instance, 3));
        tcpIpInterface
            .setPhysicalLinkObject(this.getPhysicalLinkObject(instance));
        ...
        throws Exception
    {
        ...
        if (!services[0].getName().toLowerCase().startsWith("comm")) {
            throw new Exception(
                "Expected EtherIP communication service, got "
                + services[0].getName());
        }
     ...
     */
    public CIPData[] readStringTags(final String... tags)
        throws Exception
    {
     ...
     *  @throws Exception on error
     */
    public CIPData readTag(final String tag)
        throws Exception
    {
     ...
     *  @throws Exception on error
     */
    public CIPData readTag(final String tag, final short count)
        throws Exception
    {
    ...
    public CIPData[] readTags(
            final int maxNumberOfRequestsPerGroup,
            final String... tags)
        throws Exception
    {
        ...
        _statuses = new int[reads.length];
        for (int i = 0; i < results.length; ++i) {
            results[i] = reads[i].getData();
            _statuses[i] = reads[i].getStatus();
        }
        ...
        throws Exception
    {
        ...
        for (int i = 0; i < reads.length; ++i) {
            reads[i] = new MRChipReadProtocol(tags[i], (short) counts[i]);
        }
        ...
        final Encapsulation encap = new Encapsulation(
            ...
            new SendRRDataProtocol(
                new UnconnectedSendProtocol(
                    connection.getSlot(),
                    new MessageRouterProtocol(
                            CNService.CIP_MultiRequest,
                                    MessageRouter(),
                                    new CIPMultiRequestProtocol(reads)))));

        connection.execute(encap);

        final CIPData[] data = new CIPData[reads.length];

        _statuses = new int[reads.length];

        for (int i = 0; i < reads.length; ++i) {
            data[i] = reads[i].getData();
    ...
    public void sendMultiMessages(
            final int maxNumberOfRequestsPerGroup,
            final MessageRouterProtocol... messages)
        throws Exception
    {
        ...
        for (MessageRouterProtocol message: messages) {
            ...
            if ((currentGroupByteCount + messageSize > MAX_REQUEST_SIZE)
                    || (groupMessages.size() == maxNumberOfRequestsPerGroup)) {
                executeMultiMessages(
                    groupMessages
                        .toArray(
                            new MessageRouterProtocol[groupMessages.size()]));
        ...
        if (groupMessages.size() > 0) {
            executeMultiMessages(
                groupMessages
                    .toArray(new MessageRouterProtocol[groupMessages.size()]));
        }
    }
     ...
     *  @throws Exception on error
     */
    public void writeTag(final String tag, final CIPData value)
        throws Exception
    {
        final MRChipWriteProtocol cip_write = new MRChipWriteProtocol(
            tag,
            value);
        ...
        final Encapsulation encap = new Encapsulation(
            ...
            this.connection.getSession(),
            new SendRRDataProtocol(
                new UnconnectedSendProtocol(this.slot, cip_write)));
        ...
        throws Exception
    {
        if (tags.length != values.length) {
            throw new IllegalArgumentException(
                "Got " + tags.length + " tags but " + values.length
                + " values");
        }

        final MRChipWriteProtocol[] writes =
            new MRChipWriteProtocol[tags.length];
        ...
        _statuses = new int[writes.length];
        for (int i = 0; i < writes.length; ++i) {
            _statuses[i] = writes[i].getStatus();
        }
    }
     ...
     *  @throws Exception on error
     */
    private void executeMultiMessages(
            final MessageRouterProtocol[] messages)
        throws Exception
    {
        final Encapsulation encap = new Encapsulation(
    ...
    {
        try {
            if ((this.connection.getSession() == 0)
