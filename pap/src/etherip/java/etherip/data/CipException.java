    ...
    extends Exception
{
     ...
     */
    public CipException(
            final int generalStatusCode,
            final int extendedStatusCode)
    {
        super(
            String
                .format(
                    "Status: 0x%02X %s - Extended: 0x%02X %s",
                    generalStatusCode & 0xFF,
                    (GENERAL_STATUSES
                            .containsKey(
                                    generalStatusCode & 0xFF)? Arrays
                                            .toString(
                                                    GENERAL_STATUSES
                                                            .get(generalStatusCode
                                                            & 0xFF)): ""),
                    extendedStatusCode,
                    (EXTENDED_STATUSES
                            .containsKey(
                                    extendedStatusCode)? Arrays
                                            .toString(
                                                    EXTENDED_STATUSES
                                                            .get(extendedStatusCode)): "")));
    ...
    private static HashMap<Integer, String[]> GENERAL_STATUSES =
        new HashMap<>();
    private static HashMap<Integer, String[]> EXTENDED_STATUSES =
        new HashMap<>();
    ...
    static {
        ...
        GENERAL_STATUSES
            .put(
                0x01,
                new String[] {"Connection failure",
                        "A connection related service failed along the connection path."});
        GENERAL_STATUSES
            .put(
                0x02,
                new String[] {"Resource unavailable",
                        "Resources needed for the object to perform the requested service were unavailable."});
        GENERAL_STATUSES
            .put(
                0x03,
                new String[] {"Invalid parameter value", "See Status Code 0x20",
                        "which is the preferred value to use for this condition."});
        GENERAL_STATUSES
            .put(
                0x04,
                new String[] {"Path segment error",
        ...
        GENERAL_STATUSES
            .put(
                0x05,
                new String[] {"Path destination unknown",
        ...
        GENERAL_STATUSES
            .put(
                0x21,
                new String[] {"Write-once value or medium already written",
        ...
        GENERAL_STATUSES
            .put(
                0x22,
                new String[] {"Invalid Reply Received",
        ...
        GENERAL_STATUSES
            .put(
                0x27,
                new String[] {"Unexpected attribute in list",
                        "An attempt was made to set an attribute that is not able to be set at this time."});
        GENERAL_STATUSES
            .put(
                0x28,
                new String[] {"Invalid Member ID The Member ID",
                        "specified in the request does not exist in the specified Class/Instance/Attribute."});
        GENERAL_STATUSES
            .put(
                0x29,
                new String[] {"Member not settable",
                        "A request to modify a non-modifiable member was received."});
        GENERAL_STATUSES
            .put(
                0x2A,
                new String[] {"Group 2 only server general failure",
        ...
        GENERAL_STATUSES
            .put(
                0x2B,
                new String[] {"Unknown Modbus Error",
    ...
    static {
        ...
        EXTENDED_STATUSES
            .put(
                0x0107,
                new String[] {"TARGET CONNECTION NOT FOUND",
                        "This extended status code shall be returned in response to the forward_close request, when the connection that is to be closed is not found at the target node. This extended status code shall only be returned by a target node. Routers shall not generate this extended status code. If the specified connection is not found at the intermediate node, the close request shall still be forwarded using the path specified in the Forward_Close request."});
        EXTENDED_STATUSES
            .put(
                0x0204,
                new String[] {"UNCONNECTED REQUEST TIMED OUT",
                        "The Unconnected Request Timed Out error shall occur when the UCMM times out before a reply is received. This may occur for an Unconnected_Send, Forward_Open, or Forward_Close service. This typically means that the UCMM has tried a link specific number of times using a link specific retry timer and has not received an acknowledgement or reply. This may be the result of congestion at the destination node or may be the result of a node not being powered up or present. This extended status code shall be returned by the originating node or any intermediate node."});
        EXTENDED_STATUSES
            .put(
                0x0312,
                new String[] {"LINK ADDRESS NOT VALID",
                        "Link Address specified in Port Segment Not Valid This extended status code is the result of a port segment that specifies a link address that is not valid for the target network type. This extended status code shall not be used for link addresses that are valid for the target network type but do not respond."});
        EXTENDED_STATUSES
            .put(
                0x0318,
                new String[] {"LINK ADDRESS TO SELF INVALID",
        ...
        EXTENDED_STATUSES
            .put(
                0x2107,
                new String[] {"CIP Write Tag error",
