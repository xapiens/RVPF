 ...
 *
 * $Id: AnalogInputVariation.java 3977 2019-05-11 20:32:50Z SFB $
 */
...
/**
 * Analog Input variation enumeration.
 */
public enum AnalogInputVariation
    implements ObjectVariation
{
    ANY(0, "Any", G30V0.class, Optional.empty()),
    INTEGER_WITH_FLAG(1, "32-bit with flag", G30V1.class, Optional
        .of(DataType.INT32)),
    SHORT_WITH_FLAG(2, "16-bit with flag", G30V2.class, Optional
        .of(DataType.INT16)),
    INTEGER_WITHOUT_FLAG(3, "32-bit without flag", G30V3.class, Optional
        .of(DataType.INT32)),
    SHORT_WITHOUT_FLAG(4, "16-bit without flag", G30V4.class, Optional
        .of(DataType.INT16)),
    FLOAT_WITH_FLAG(5, "Single-precision with flag", G30V5.class, Optional
        .of(DataType.FLOAT16)),
    DOUBLE_WITH_FLAG(6, "Double-precision with flag", G30V6.class, Optional
        .of(DataType.FLOAT32));
    ...
    @Nonnull
    @CheckReturnValue
    public static AnalogInputVariation instance(final int variationCode)
    {
        return Require
