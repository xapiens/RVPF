 ...
 *
 * $Id: FrozenCounterVariation.java 3978 2019-05-12 10:53:03Z SFB $
 */
...
/**
 * Frozen Counter variation enumeration.
 */
public enum FrozenCounterVariation
    implements ObjectVariation
{
    ANY(0, "Any", G21V0.class, Optional.empty()),
    UNSIGNED_WITH_FLAG(1, "32-bit with flag", G21V1.class, Optional
        .of(DataType.UINT32)),
    WORD_WITH_FLAG(2, "16-bit with flag", G21V2.class, Optional
        .of(DataType.UINT16)),
    UNSIGNED_WITH_FLAG_TIME(5, "32-bit with flag and time", G21V5.class,
            Optional
                .of(DataType.UINT32)),
    WORD_WITH_FLAG_TIME(6, "16-bit with flag and time", G21V6.class, Optional
        .of(DataType.UINT16)),
    UNSIGNED_WITHOUT_FLAG(9, "32-bit without flag", G21V9.class, Optional
        .of(DataType.UINT32)),
    WORD_WITHOUT_FLAG(10, "16-bit without flag", G21V10.class, Optional
        .of(DataType.UINT16));
    ...
    @Nonnull
    @CheckReturnValue
    public static FrozenCounterVariation instance(final int variationCode)
    {
        return Require
