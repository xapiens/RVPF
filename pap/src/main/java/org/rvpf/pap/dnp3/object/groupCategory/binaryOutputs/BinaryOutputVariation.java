 ...
 *
 * $Id: BinaryOutputVariation.java 3977 2019-05-11 20:32:50Z SFB $
 */
...
/**
 * Binary Output variation enumeration.
 */
public enum BinaryOutputVariation
    implements ObjectVariation
{
    ...
    @Nonnull
    @CheckReturnValue
    public static BinaryOutputVariation instance(final int variationCode)
    {
        return Require
