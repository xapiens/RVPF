 ...
 *
 * $Id: AnalogOutputsGroup.java 3977 2019-05-11 20:32:50Z SFB $
 */
...
/**
 * Analog Outputs group enumeration.
 */
public enum AnalogOutputsGroup
    implements ObjectGroup
{
    ANALOG_OUTPUT_STATUS(40, "Analog Output Status",
            AnalogOutputStatusVariation.class),
    ANALOG_OUTPUT_COMMAND(41, "Analog Output Command",
            AnalogOutputCommandVariation.class),
    ANALOG_OUTPUT_EVENT(42, "Analog Output Event",
            AnalogOutputEventVariation.class),
    ANALOG_OUTPUT_COMMAND_EVENT(43, "Analog Output Command Event",
            AnalogOutputCommandEventVariation.class);
    ...
    @Nonnull
    @CheckReturnValue
    public static AnalogOutputsGroup instance(final int groupCode)
    {
