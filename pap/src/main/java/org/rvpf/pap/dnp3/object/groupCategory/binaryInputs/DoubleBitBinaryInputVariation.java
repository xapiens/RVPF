 ...
 *
 * $Id: DoubleBitBinaryInputVariation.java 3977 2019-05-11 20:32:50Z SFB $
 */
...
/**
 * Double-bit Binary Input variation enumeration.
 */
public enum DoubleBitBinaryInputVariation
    implements ObjectVariation
{
    ANY(0, "Any", G3V0.class),
    PACKED_FORMAT(1, "Packed format", G3V1.class),
    WITH_FLAGS(2, "With flags", G3V2.class);
    ...
    @Nonnull
    @CheckReturnValue
    public static DoubleBitBinaryInputVariation instance(
    ...
    {
        return BinaryInputsGroup.DOUBLE_BIT_BINARY_INPUT;
    }
    ...
    private static final Map<Integer, DoubleBitBinaryInputVariation> _VARIATION_MAP =
        MapFactory
            .codeMap(values());
