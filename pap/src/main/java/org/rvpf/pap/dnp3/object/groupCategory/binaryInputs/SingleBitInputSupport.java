 ...
 *
 * $Id: SingleBitInputSupport.java 3961 2019-05-06 20:14:59Z SFB $
 */
...
/**
 * Single-bit input support.
 */
public class SingleBitInputSupport
    implements PointType.Support
{
    ...
    {
        return BinaryInputVariation.ANY;
    }
    ...
    public Optional<ObjectVariation> getInputVariation(final DataType dataType)
    {
        switch (dataType) {
            case BSTR1:
                return Optional.of(BinaryInputVariation.WITH_FLAGS);
            default:
    ...
    {
        return PointType.SINGLE_BIT_INPUT;
    }
