 ...
 *
 * $Id: BinaryInputEventVariation.java 3977 2019-05-11 20:32:50Z SFB $
 */
...
/**
 * Binary Input Event variation enumeration.
 */
public enum BinaryInputEventVariation
    implements ObjectVariation
{
    ANY(0, "Any", G2V0.class),
    WITHOUT_TIME(1, "Without time", G2V1.class),
    WITH_ABSOLUTE_TIME(2, "With absolute time", G2V2.class),
    WITH_RELATIVE_TIME(3, "With relative time", G2V3.class);
    ...
    @Nonnull
    @CheckReturnValue
    public static BinaryInputEventVariation instance(final int variationCode)
    {
        return Require
    ...
    {
        return BinaryInputsGroup.BINARY_INPUT_EVENT;
    }
    ...
    private static final Map<Integer, BinaryInputEventVariation> _VARIATION_MAP =
        MapFactory
            .codeMap(values());
