 ...
 *
 * $Id: AnalogInputEventVariation.java 3977 2019-05-11 20:32:50Z SFB $
 */
...
/**
 * Analog Input Event variation enumeration.
 */
public enum AnalogInputEventVariation
    implements ObjectVariation
{
    ANY(0, "Any", G32V0.class, Optional.empty()),
    INTEGER_WITHOUT_TIME(1, "32-bit without time", G32V1.class, Optional
        .of(DataType.INT32)),
    SHORT_WITHOUT_TIME(2, "16-bit without time", G32V2.class, Optional
        .of(DataType.INT16)),
    INTEGER_WITH_TIME(3, "32-bit with time", G32V3.class, Optional
        .of(DataType.INT32)),
    SHORT_WITH_TIME(4, "16-bit with time", G32V4.class, Optional
        .of(DataType.INT16)),
    FLOAT_WITHOUT_TIME(5, "Single-precision without time", G32V5.class, Optional
        .of(DataType.FLOAT16)),
    DOUBLE_WITHOUT_TIME(6, "Double-precision without time", G32V6.class,
            Optional
                .of(DataType.FLOAT32)),
    FLOAT_WITH_TIME(7, "Single-precision with time", G32V7.class, Optional
        .of(DataType.FLOAT16)),
    DOUBLE_WITH_TIME(8, "Double-precision with time", G32V8.class, Optional
        .of(DataType.FLOAT32));
    ...
    @Nonnull
    @CheckReturnValue
    public static AnalogInputEventVariation instance(final int variationCode)
    {
        return Require
