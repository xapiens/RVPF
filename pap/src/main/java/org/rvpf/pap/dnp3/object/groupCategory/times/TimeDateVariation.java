 ...
 *
 * $Id: TimeDateVariation.java 3978 2019-05-12 10:53:03Z SFB $
 */
...
/**
 * Time and Date variation enumeration.
 */
public enum TimeDateVariation
    implements ObjectVariation
{
    ...
    ABSOLUTE_TIME_LAST_RECORDED(3, "Absolute time at last recorded time",
            G50V3.class),
    INDEXED_TIME_INTERVAL(4, "Indexed absolute time and long interval",
            G50V4.class);
    ...
    @Nonnull
    @CheckReturnValue
    public static TimeDateVariation instance(final int variationCode)
    {
        return Require
