 ...
 *
 * $Id: DoubleBitBinaryInputEventVariation.java 3977 2019-05-11 20:32:50Z SFB $
 */
...
/**
 * Double-bit Binary Input Event variation enumeration.
 */
public enum DoubleBitBinaryInputEventVariation
    implements ObjectVariation
{
    ANY(0, "Any", G4V0.class),
    WITHOUT_TIME(1, "Without time", G4V1.class),
    WITH_ABSOLUTE_TIME(2, "With absolute time", G4V2.class),
    WITH_RELATIVE_TIME(3, "With relative time", G4V3.class);
     ...
     */
    DoubleBitBinaryInputEventVariation(
            final int code,
    ...
    @Nonnull
    @CheckReturnValue
    public static DoubleBitBinaryInputEventVariation instance(
    ...
    {
        return BinaryInputsGroup.DOUBLE_BIT_BINARY_INPUT_EVENT;
    }
    ...
    private static final Map<Integer, DoubleBitBinaryInputEventVariation> _VARIATION_MAP =
        MapFactory
            .codeMap(values());
