 ...
 *
 * $Id: G1V2.java 3976 2019-05-11 17:26:10Z SFB $
 */
...
/**
 * Packed format With flags.
 */
public final class G1V2
    ...
    implements ObjectInstance.WithValue, ObjectInstance.WithFlags
{
    ...
    {
        return BinaryInputVariation.WITH_FLAGS;
    }
    ...
    {
        return Boolean.valueOf(_flags.getState());
    }
    ...
    {
        _flags.setState(WithValue.booleanValue(value));
    }
