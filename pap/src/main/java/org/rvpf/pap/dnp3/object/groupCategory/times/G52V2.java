 ...
 *
 * $Id: G52V2.java 3961 2019-05-06 20:14:59Z SFB $
 */
    ...
    implements ObjectInstance.WithValue
{
    ...
    {
        return TimeDelayVariation.FINE;
    }
    ...
    {
        return Integer.valueOf(_milliseconds & 0xFFFF);
    }
    ...
    {
        _milliseconds = WithValue.shortValue(value);
    }
