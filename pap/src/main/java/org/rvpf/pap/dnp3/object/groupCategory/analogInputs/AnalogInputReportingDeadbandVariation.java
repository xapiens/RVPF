 ...
 *
 * $Id: AnalogInputReportingDeadbandVariation.java 3977 2019-05-11 20:32:50Z SFB $
 */
...
/**
 * Analog Input Reporting Deadband variation enumeration.
 */
public enum AnalogInputReportingDeadbandVariation
    implements ObjectVariation
{
     ...
     */
    AnalogInputReportingDeadbandVariation(
            final int code,
    ...
    @Nonnull
    @CheckReturnValue
    public static AnalogInputReportingDeadbandVariation instance(
