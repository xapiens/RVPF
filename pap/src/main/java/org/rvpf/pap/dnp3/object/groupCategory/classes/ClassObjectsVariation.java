 ...
 *
 * $Id: ClassObjectsVariation.java 3978 2019-05-12 10:53:03Z SFB $
 */
...
/**
 * Class Object variation enumeration.
 */
public enum ClassObjectsVariation
    implements ObjectVariation
{
    ...
    @Nonnull
    @CheckReturnValue
    public static ClassObjectsVariation instance(final int variationCode)
    {
        return Require
