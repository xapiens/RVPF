 ...
 *
 * $Id: CounterSupport.java 3961 2019-05-06 20:14:59Z SFB $
 */
    ...
    implements PointType.Support
{
    ...
    public Optional<ObjectVariation> getInputVariation(final DataType dataType)
    {
        switch (dataType) {
            case UINT16:
                return Optional.of(CounterVariation.WORD_WITH_FLAG);
            case UINT32:
                return Optional.of(CounterVariation.UNSIGNED_WITH_FLAG);
            default:
