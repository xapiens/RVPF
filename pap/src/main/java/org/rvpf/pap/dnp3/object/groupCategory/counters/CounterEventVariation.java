 ...
 *
 * $Id: CounterEventVariation.java 3978 2019-05-12 10:53:03Z SFB $
 */
...
/**
 * Counter Event variation enumeration.
 */
public enum CounterEventVariation
    implements ObjectVariation
{
    ANY(0, "Any", G22V0.class, Optional.empty()),
    UNSIGNED_WITH_FLAG(1, "32-bit with flag", G22V1.class, Optional
        .of(DataType.UINT32)),
    WORD_WITH_FLAG(2, "16-bit with flag", G22V2.class, Optional
        .of(DataType.UINT16)),
    UNSIGNED_WITH_FLAG_TIME(5, "32-bit with flag and time", G22V5.class,
            Optional
                .of(DataType.UINT32)),
    WORD_WITH_FLAG_TIME(6, "16-bit with flag and time", G22V6.class, Optional
        .of(DataType.UINT16));
    ...
    @Nonnull
    @CheckReturnValue
    public static CounterEventVariation instance(final int variationCode)
    {
        return Require
    ...
    {
        return CountersGroup.COUNTER_EVENT;
    }
    ...
    private static final Map<Integer, CounterEventVariation> _VARIATION_MAP =
        MapFactory
            .codeMap(values());
