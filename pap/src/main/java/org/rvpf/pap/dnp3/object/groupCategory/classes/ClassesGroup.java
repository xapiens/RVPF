 ...
 *
 * $Id: ClassesGroup.java 3978 2019-05-12 10:53:03Z SFB $
 */
...
/**
 * Classes group enumeration.
 */
public enum ClassesGroup
    implements ObjectGroup
{
    CLASS_OBJECTS(60, "Class Objects", ClassObjectsVariation.class);
    ...
    @Nonnull
    @CheckReturnValue
    public static ClassesGroup instance(final int groupCode)
    {
    ...
    private static final Map<Integer, ClassesGroup> _GROUP_MAP = MapFactory
        .codeMap(values());
