 ...
 *
 * $Id: G33V6.java 3976 2019-05-11 17:26:10Z SFB $
 */
...
/**
 * Frozen Analog Input Event Double-precision without time.
 */
public class G33V6
    ...
    implements ObjectInstance.WithValue, ObjectInstance.WithFlags
{
    ...
    {
        return FrozenAnalogInputEventVariation.DOUBLE_WITHOUT_TIME;
    }
