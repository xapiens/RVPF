 ...
 *
 * $Id: TimeDelayVariation.java 3978 2019-05-12 10:53:03Z SFB $
 */
...
/**
 * Time Delay variation enumeration.
 */
public enum TimeDelayVariation
    implements ObjectVariation
{
    ...
    @Nonnull
    @CheckReturnValue
    public static TimeDelayVariation instance(final int variationCode)
    {
        return Require
