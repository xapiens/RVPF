 ...
 *
 * $Id: G43V6.java 3976 2019-05-11 17:26:10Z SFB $
 */
...
/**
 * Analog Output Command Event Double-precision without time.
 */
public class G43V6
    ...
    implements ObjectInstance.WithValue, ObjectInstance.WithStatus
{
    ...
    {
        return AnalogOutputCommandEventVariation.DOUBLE_WITHOUT_TIME;
    }
