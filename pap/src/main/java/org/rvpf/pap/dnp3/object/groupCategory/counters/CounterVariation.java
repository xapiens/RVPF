 ...
 *
 * $Id: CounterVariation.java 3978 2019-05-12 10:53:03Z SFB $
 */
...
/**
 * Counter variation enumeration.
 */
public enum CounterVariation
    implements ObjectVariation
{
    ANY(0, "Any", G20V0.class, Optional.empty()),
    UNSIGNED_WITH_FLAG(1, "32-bit with flag", G20V1.class, Optional
        .of(DataType.UINT32)),
    WORD_WITH_FLAG(2, "16-bit with flag", G20V2.class, Optional
        .of(DataType.UINT16)),
    UNSIGNED_WITHOUT_FLAG(5, "32-bit without flag", G20V5.class, Optional
        .of(DataType.UINT32)),
    WORD_WITHOUT_FLAG(6, "16-bit without flag", G20V6.class, Optional
        .of(DataType.UINT16));
    ...
    @Nonnull
    @CheckReturnValue
    public static CounterVariation instance(final int variationCode)
    {
        return Require
    ...
    private static final Map<Integer, CounterVariation> _VARIATION_MAP =
        MapFactory
            .codeMap(values());
