 ...
 *
 * $Id: G33V5.java 3976 2019-05-11 17:26:10Z SFB $
 */
...
/**
 * Frozen Analog Input Event Single-precision without time.
 */
public class G33V5
    ...
    implements ObjectInstance.WithValue, ObjectInstance.WithFlags
{
    ...
    {
        return ObjectFlags.BYTES + Float.BYTES;
    }
    ...
    {
        return FrozenAnalogInputEventVariation.FLOAT_WITHOUT_TIME;
    }
