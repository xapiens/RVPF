 ...
 *
 * $Id: G3V2.java 3976 2019-05-11 17:26:10Z SFB $
 */
    ...
    implements ObjectInstance.WithValue, ObjectInstance.WithFlags
{
    ...
    {
        return DoubleBitBinaryInputVariation.WITH_FLAGS;
    }
    ...
    {
        return _flags.getDoubleBitState();
    }
    ...
    {
        _flags.setDoubleBitState(WithValue.doubleBitStateValue(value));
    }
