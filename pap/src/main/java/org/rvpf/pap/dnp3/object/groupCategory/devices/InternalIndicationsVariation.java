 ...
 *
 * $Id: InternalIndicationsVariation.java 3978 2019-05-12 10:53:03Z SFB $
 */
...
/**
 * Internal Indications variation enumeration.
 */
public enum InternalIndicationsVariation
    implements ObjectVariation
{
    ...
    @Nonnull
    @CheckReturnValue
    public static InternalIndicationsVariation instance(final int variationCode)
    {
        return Require
