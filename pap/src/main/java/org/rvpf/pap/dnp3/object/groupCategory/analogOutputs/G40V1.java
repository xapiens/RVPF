 ...
 *
 * $Id: G40V1.java 3976 2019-05-11 17:26:10Z SFB $
 */
    ...
    implements ObjectInstance.WithValue, ObjectInstance.WithFlags
{
    ...
    {
        return ObjectFlags.BYTES + Integer.BYTES;
    }
    ...
    {
        return AnalogOutputStatusVariation.INTEGER_WITH_FLAG;
    }
