 ...
 *
 * $Id: TimesGroup.java 3978 2019-05-12 10:53:03Z SFB $
 */
...
/**
 * Times group enumeration.
 */
public enum TimesGroup
    implements ObjectGroup
{
    TIME_DATE(50, "Time and Date", TimeDateVariation.class),
    TIME_DATE_COMMON_TOO(51, "Time and Date Common Time-of-Occurrence",
            TimeDateCommonTooVariation.class),
    ...
    @Nonnull
    @CheckReturnValue
    public static TimesGroup instance(final int groupCode)
    {
    ...
    private static final Map<Integer, TimesGroup> _GROUP_MAP = MapFactory
        .codeMap(values());
