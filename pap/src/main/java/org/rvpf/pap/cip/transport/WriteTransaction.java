 ...
 *
 * $Id: WriteTransaction.java 4083 2019-06-15 12:53:56Z SFB $
 */
    ...
    extends Transaction
{
     ...
     */
    public WriteTransaction(@Nonnull final CIPServerProxy serverProxy)
    {
        super(serverProxy);
    }
     ...
     */
    @Nonnull
    public Request addRequest(@Nonnull final PointValue pointValue)
    {
