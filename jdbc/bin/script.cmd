...
REM $Id: script.cmd 3194 2016-09-28 17:17:14Z SFB $
...
SET CLASSPATH=%CLASSPATH%;%RVPF_CORE_LIB%\log4j-api.jar
SET CLASSPATH=%CLASSPATH%;%RVPF_CORE_LIB%\log4j-core.jar
SET CLASSPATH=%CLASSPATH%;%RVPF_CORE_LIB%\log4j-jul.jar
SET CLASSPATH=%CLASSPATH%;%RVPF_LIB%\lib\rvpf-jdbc.jar
