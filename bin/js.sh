...
# $Id: js.sh 3824 2018-11-17 15:29:27Z SFB $
...
CLASSPATH=$CLASSPATH:$RVPF_CORE_SHARE_JAVA/rvpf-processor.jar
CLASSPATH=$CLASSPATH:$RVPF_CORE_SHARE_JAVA/rvpf-forwarder.jar
