...
public class SmtpRequest {
     ...
     * @param commandParams     remainder of command line once command is removed
     * @param smtpState      current SMTP server state
     */
    public SmtpRequest(final SmtpActionType actionType, final String commandParams, final SmtpState smtpState) {
