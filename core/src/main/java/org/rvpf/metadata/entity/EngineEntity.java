 ...
 *
 * $Id: EngineEntity.java 4076 2019-06-11 17:09:30Z SFB $
 */
    ...
    extends ProxyEntity
{
     ...
     *
     * @return The optional Engine instance.
     */
    ...
    {
        return (Optional<? extends Engine>) getInstance();
    }
    ...
    public static final String ENTITY_PREFIX = "G";

    /** Engine reference name. */
    public static final String ENTITY_REFERENCE_NAME = "engine";
        ...
        extends ProxyEntity.Builder
    {
         ...
         */
        @Nonnull
        public Builder copyFrom(@Nonnull final EngineEntity entity)
        {
