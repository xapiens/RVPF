 ...
 *
 * $Id: MetadataServiceAppHolderActivator.java 3961 2019-05-06 20:14:59Z SFB $
 */
 ...
 */
public class MetadataServiceAppHolderActivator
    extends ServiceActivator
{
    ...
    {
        new MetadataServiceAppHolderActivator().run(args);
    }
    ...
    {
        return createServiceImpl(MetadataServiceAppHolderImpl.class);
    }
}
