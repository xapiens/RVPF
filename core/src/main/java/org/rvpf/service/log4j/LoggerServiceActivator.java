 ...
 *
 * $Id: LoggerServiceActivator.java 3961 2019-05-06 20:14:59Z SFB $
 */
 ...
 *
 * @see LoggerServiceImpl
 */
public final class LoggerServiceActivator
    extends ServiceActivator
{
    ...
    {
        new LoggerServiceActivator().run(args);
    }
    ...
    {
        return createServiceImpl(LoggerServiceImpl.class);
    }
}
