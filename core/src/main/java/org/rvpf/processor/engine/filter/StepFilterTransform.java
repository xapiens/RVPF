 ...
 *
 * $Id: StepFilterTransform.java 4039 2019-05-31 17:53:15Z SFB $
 */
 ...
 */
final class StepFilterTransform
    extends AbstractTransform
{
    ...
    public Optional<? extends Transform> getInstance(final Point point)
    {
        ...
        if (!StepFilteredBehavior.class.isInstance(behavior)) {
            getThisLogger()
                .error(
                    ProcessorMessages.TRANSFORM_BEHAVIOR_1,
                    getName(),
                    StepFilteredBehavior.class.getName(),
                    point);
