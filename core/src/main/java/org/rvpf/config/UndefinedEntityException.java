 ...
 *
 * $Id: UndefinedEntityException.java 3902 2019-02-20 22:30:12Z SFB $
 */
    ...
    extends Exception
{
     ...
     *
     * @param entity The undefined entity.
     */
    public UndefinedEntityException(@Nonnull final Entity entity)
    {
        super(
            Message
                .format(
