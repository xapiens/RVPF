 ...
 *
 * $Id: DatabaseServiceActivator.java 3961 2019-05-06 20:14:59Z SFB $
 */
    ...
    extends ServiceActivator
{
    ...
    {
        new DatabaseServiceActivator().run(args);
    }
    ...
    {
        return createServiceImpl(DatabaseServiceImpl.class);
    }
}
