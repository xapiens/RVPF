 ...
 *
 * $Id: ExtrapolatedValue.java 3961 2019-05-06 20:14:59Z SFB $
 */
 ...
 */
@NotThreadSafe
public final class ExtrapolatedValue
    extends SynthesizedValue
{
    ...
    private ExtrapolatedValue(@Nonnull final ExtrapolatedValue other)
    {
        super(other);
    }
     ...
     */
    @Override
    public ExtrapolatedValue copy()
    {
        return new ExtrapolatedValue(this);
    }
