 ...
 *
 * $Id: Signal.java 3961 2019-05-06 20:14:59Z SFB $
 */
 ...
 * Service signal.
 *
 * <p>Instances are used to request actions from other services.</p>
 */
@ThreadSafe
    ...
    extends Alert
{
     ...
     * @param entityName The name of the entity associated with the source.
    ...
    {
        return BaseMessages.SIGNAL_TYPE.toString();
    }
