 ...
 *
 * $Id: BigRationalConverter.java 3900 2019-02-19 20:43:24Z SFB $
 */
...
/**
 * Big rational converter.
 */
public class BigRationalConverter
    ...
    implements XStreamStreamer.Converter
{
    ...
    {
        return type.equals(BigRational.class);
    }
    ...
    {
        return BigRational.valueOf(string);
    }
    ...
    public boolean setUp(final XStreamStreamer streamer)
    {
        ...
        xstream.alias(BIG_RATIONAL_ELEMENT, BigRational.class);
    ...
    /** Big rational element. */
    public static final String BIG_RATIONAL_ELEMENT = "big-rational";
}
