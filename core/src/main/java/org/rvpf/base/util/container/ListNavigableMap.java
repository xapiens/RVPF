 ...
 *
 * $Id: ListNavigableMap.java 3892 2019-02-13 13:24:20Z SFB $
 */
 ...
 */
public interface ListNavigableMap<K, V>
    extends ListMap<K, V>, NavigableMap<K, List<V>>
{
    /**
        ...
        implements ListNavigableMap<K, V>
    {
         ...
         */
        protected Abstract(@Nonnull final NavigableMap<K, List<V>> map)
        {
            super(map);
