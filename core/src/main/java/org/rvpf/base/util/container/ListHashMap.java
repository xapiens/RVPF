 ...
 *
 * $Id: ListHashMap.java 3892 2019-02-13 13:24:20Z SFB $
 */
 ...
 * List hash map.
 *
 * <p>Uses a HashMap to allow multiple values for a single key.</p>
 *
    ...
    extends ListMap.Abstract<K, V>
{
     ...
     */
    public ListHashMap(final int initialCapacity)
    {
     ...
     */
    public ListHashMap(@Nonnull final Map<K, List<V>> map)
    {
