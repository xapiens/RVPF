 ...
 *
 * $Id: UpdateContext.java 4020 2019-05-23 14:37:22Z SFB $
 */
    ...
    extends StoreClient
{
    ...
    /**
     * Uses the supplied point values to update its store.
     *
     * @param updates The point values.
    ...
    @Nonnull
    @CheckReturnValue
    synchronized Optional<Exception[]> update(
        ...
        throws ServiceSessionException
    {
        ...
        try {
            responses = getStore().update(updates);
        } catch (final SessionException exception) {
            throw new ServiceSessionException(exception);
        }
