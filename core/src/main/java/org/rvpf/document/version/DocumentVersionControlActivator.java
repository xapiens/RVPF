 ...
 *
 * $Id: DocumentVersionControlActivator.java 3961 2019-05-06 20:14:59Z SFB $
 */
 ...
 *
 * @see DocumentVersionControlImpl
 */
public final class DocumentVersionControlActivator
    extends ServiceActivator
{
    ...
    {
        new DocumentVersionControlActivator().run(args);
    }
    ...
    {
        return createServiceImpl(DocumentVersionControlImpl.class);
    }
}
