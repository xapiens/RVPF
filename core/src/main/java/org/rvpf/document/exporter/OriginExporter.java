 ...
 *
 * $Id: OriginExporter.java 3961 2019-05-06 20:14:59Z SFB $
 */
    ...
    extends ParamsEntityExporter
{
     ...
     */
    OriginExporter(@Nonnull final MetadataExporter owner)
    {
        super(owner, OriginEntity.class);
    }
    ...
    {
        return MetadataElementLoader.ORIGIN_ENTITY;
    }
}
