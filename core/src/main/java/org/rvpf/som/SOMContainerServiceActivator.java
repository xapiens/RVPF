 ...
 *
 * $Id: SOMContainerServiceActivator.java 3961 2019-05-06 20:14:59Z SFB $
 */
 ...
 *
 * @see SOMContainerServiceImpl
 */
public final class SOMContainerServiceActivator
    extends ServiceActivator
{
    ...
    {
        new SOMContainerServiceActivator().run(args);
    }
    ...
    {
        return createServiceImpl(SOMContainerServiceImpl.class);
    }
}
