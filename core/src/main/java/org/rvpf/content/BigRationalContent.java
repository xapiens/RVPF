 ...
 *
 * $Id: BigRationalContent.java 3936 2019-04-28 19:25:00Z SFB $
 */
    ...
    extends FloatingPointContent
{
    ...
    {
        return _getBigRational(pointValue);
    }
    ...
    {
        return _getBigRational(normalizedValue);
    }
    ...
    private BigRational _getBigRational(final PointValue pointValue)
    {
        ...
        if (value instanceof Number) {
            return BigRational.valueOf(((Number) value).longValue(), 1);
        }

        if (value instanceof String) {
            try {
                return BigRational.valueOf((String) value);
            } catch (final NumberFormatException exception) {
                // Ignore (will warn).
            }
        } else if (value instanceof Boolean) {
            return BigRational
                .valueOf(((Boolean) value).booleanValue()? 1: 0, 1);
        }
